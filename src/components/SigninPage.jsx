  ...
  return (
    <div className="flex h-screen">
      ...
      <div className="w-[50%] flex bg-black flex-col justify-center items-center relative p-5">
        ...
        <div className="text-left absolute left-[80px] w-[358px] h-[186px]">
          <h1 className="text-[40px] text-white font-medium">Welcome Back to</h1>
          <h1 className="text-[40px] text-white font-medium mb-2">Your AI Workforce</h1>
          <h1 className='text-[20px] text-[#B4B1B1]'>Access your virtual team and</h1>
          <h1 className='text-[20px] text-[#B4B1B1]'>get things done faster</h1>
        </div>
      </div>
      ...
      <div className="w-[50%] bg-lightGray flex flex-col justify-center items-center">
        <div className="w-[407px] h-[351px] bg-customGray rounded-xl shadow-md ">
            ...
            <h2 className="text-[24px] text-white font-medium">Sign in</h2>
          <div className=' '>
          <p className="text-[14px] text-[#C9C9C9] mt-[6px] leading-[normal]">
            New to Polymaths.AI? <span className="text-cpurple cursor-pointer leading-[normal] " onClick={()=>nav("/signup")}>Sign up for an account</span>
          </p>
          </div>
